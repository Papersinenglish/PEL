...
<div className="p-3">
        ...
        <h3 className="p-2" >Editions</h3>
            <Link to="/volume27-no-1"><div className="pub-header p-2"><p><strong>Current Issue -</strong>  Volume 27 - No 1</p></div></Link>
            ...
            <Link to="/volume26-no-3&4"><p className="pub-header p-2">Volume 26 - No 3 & 4 </p></Link>          
            <hr/>    
        </section>
        </div>  
)
